...
import time
from .utils import generate_resume_insight
...
def resume_home():
    if request.method == "POST":
        ...
        try:
            ...
            insight = generate_resume_insight(
                name, role, skill, project_title, degree, time.strftime("Y")
            )
            print("Insight ready")
            print("--- All Analysis Generated ---")

            return jsonify({"name": name, "role": role, "insight": insight})
